...
urlpatterns = [
    ...
    path('emprestimo/<int:emprestimo_id>/devolucao/', views.fazer_devolucao_normal, name="item_devolvido"),
    path('emprestimo/<int:emprestimo_id>/devolucao-parcial/', views.fazer_devolucao_parcial, name="item_devolvido_parcial"),
